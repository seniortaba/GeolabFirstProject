...
{{--                        <!-- chat item -->--}}
{{--                        <div class="item">--}}
{{--                            <img src="{{ asset('images/backend_images/avatar.png') }}" alt="user image" class="online"/>--}}
{{--                            <p class="message">--}}
{{--                                <a href="#" class="name">--}}
...
{{--                        <!-- chat item -->--}}
{{--                        <div class="item">--}}
{{--                            <img src="{{ asset('images/backend_images/avatar2.png') }}" alt="user image" class="offline"/>--}}
{{--                            <p class="message">--}}
{{--                                <a href="#" class="name">--}}
...
{{--                        <!-- chat item -->--}}
{{--                        <div class="item">--}}
{{--                            <img src="{{ asset('images/backend_images/avatar3.png') }}" alt="user image" class="offline"/>--}}
{{--                            <p class="message">--}}
{{--                                <a href="#" class="name">--}}
